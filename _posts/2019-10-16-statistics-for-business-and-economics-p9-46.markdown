---
layout: post
title: "statistics-for-business-and-economics-p9-46"
date:  2019-10-17 17:00:00  +0800
categories: [dev]
tags: [statistics]
---
...
## question
```
The Honolulu Board of Water Supply suggested the water-by request rule be
adopted at restaurants on the island of Oahu to conserve water. A restaurateur
stated that 30% of the patrons do dnot drink their water. Hence the conservation
of water would come not only from the unused water in each glass, but also from
the water saved in washing the glasses. Test H0: p = 0.30 versus Ha: p != 0.30.
Assume a sample of 480 patrons at restaurants showed that 128 patrons did not
drink their water. Test the restaurater's claim at a 0.5 level of significance.
...
def main():
    hypothesis_proportion = 0.30
    sample_size = 480
    sample_proportion = 128 / sample_size
...
## output
```
hypothesis_proportion: 0.3000
sample_size: 480
sample_proportion: 0.2667
sample_standard_deviation: 0.0209

H0: population proportion = 0.3
Ha: population proportion != 0.3
significance: 0.0500
critical_z_score: 1.9600
test_statistics_z_score: -1.5936
p_value: 0.1110
