---
layout: post
title: "statistics-for-business-and-economics-p9-52"
date:  2019-10-17 18:20:00  +0800
categories: [dev]
tags: [statistics]
---
...
## question
```
In a study of the contamination of fish in the nation's rivers and lakes, the
Environmental Protection Agency found that 91% of water quality test sites
showed the presence of PCB, a cancer-causing agent(America by the Numbers,
1993). SUppose a follow-up study of 200 rivers and lakes in 1995 shows the
presence of PCB in 160 cases. Does the statistical evidence support the
conclusion that as of 1995 water clean-up programs have reducd the proportion of
locations with PCB? Use a 0.05 level of significance.
```
...
def main():
    hypothesis_proportion = 0.91
    sample_size = 200
    sample_proportion = 160  / sample_size
    ...
    critical_z_score = dcstats.lower_tailed_critical_z_score(significance)
    ...
    p_value = dcstats.lower_tailed_p_value_with_z_score(test_statistics_z_score)
...
## discuss
```
Q: Does the statistical evidence support the conclusion that as of 1995 water
clean-up programs have reducd the proportion of locations with PCB? Use a 0.05
level of significance.

A: According to implication of the alternative hypothesis, the population
proportion of location with PCB is less than that of 1995.
```
